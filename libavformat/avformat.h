...
typedef struct AVStream {
    int index;    /**< stream index in AVFormatContext */   //标识该视频/音频流, 0视频，1音频
    /**
     ...
     */
    AVRational time_base;   //时基。通过该值可以把PTS，DTS转化为真正的时间。其他结构体也有类似的字段，好像只有AVStream中的time_base是可用的。
     ...
     */
    AVRational avg_frame_rate;  //帧率，音频没有吧？
...
typedef struct AVFormatContext {
     ...
     */
    struct AVInputFormat *iformat;  // 输入的封装格式
